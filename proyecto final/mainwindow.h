...
public:
    MainWindow(int interval, QWidget *parent = nullptr); // Modificado para aceptar un intervalo
    ~MainWindow();
...
private:
    ...
    QString playerName;
    int initialInterval; // Nueva variable para el intervalo inicial
    ...
    void mousePressEvent(QMouseEvent *event) override; // Reimplementación de mousePressEvent
