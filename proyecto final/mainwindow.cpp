...
MainWindow::MainWindow(int interval, QWidget *parent)
    ...
    , clic(true)
    , initialInterval(interval) // Guardar el intervalo inicial
{
    ui->setupUi(this);
    ...
    timer->setInterval(initialInterval);  // Set the initial interval
    timer->stop();
    ...
    timerDisparoEnemigos->start(initialInterval);
}
...
void MainWindow::initGameScene() {
    ...
    for (int i = 0; i < numTrampas; ++i) {
        ...
        Trampas *trampa = new Trampas(xPos, 275, 56.07, 87, "C:/Users/JojhanSebastian/Downloads/Soldier_1/trampa.png");
        trampas.append(trampa);
        gameScene->addItem(trampa);
    }
    trampa2 = new trampas2(200, 150, 50, 50, "C:/Users/JojhanSebastian/Downloads/proyecto final/spike.png", jugador);
...
void MainWindow::updateGame() {
    ...
    if (puntajeFinal >= 5) {
        ...
        QPixmap WinImage("C:/Users/JojhanSebastian/Downloads/proyecto final/win.jpg");
    ...
    if (jug1->getContador() >= 20) {
        ...
        QPixmap gameOverImage("C:/Users/JojhanSebastian/Downloads/proyecto final/Score.txt/gameover.jpg");
