...
Enemigos::Enemigos(QGraphicsView *view, qreal startX, qreal startY, QGraphicsItem *im)
    : QGraphicsPixmapItem(im), x(startX), y(startY) {
...
Enemigos::Enemigos(const Enemigos &other, qreal newX, qreal newY)
    : QGraphicsPixmapItem(other.pixmap()), x(newX), y(newY), velocidadX(other.velocidadX), velocidadY(other.velocidadY), movingRight(other.movingRight), spriteSheet(other.spriteSheet), spriteX(other.spriteX), spriteY(other.spriteY), cont(other.cont), contadorColisiones(0) {
